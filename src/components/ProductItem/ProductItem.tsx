            ...
            <li className="list-group-item">
                <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="actions d-flex ms-3">
                        <Button variant="outline-dark" size="sm" aria-label={`Edit ${product.name}`}
                                data-tooltip-id="edit-tooltip" data-tooltip-content="Edit item"
                        ...
                        <Button variant="outline-dark" size="sm" className="delete-btn ms-1"
                                aria-label={`Delete ${product.name}`} data-tooltip-id="delete-tooltip"
                                data-tooltip-content="Delete item" data-tooltip-place="top">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="16" height="16"
